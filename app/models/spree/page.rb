class Spree::Page < ActiveRecord::Base
  ...
  has_many :spree_images, -> { where viewable_type: 'Spree::Page' }, :class_name => 'Spree::Image', foreign_key: :viewable_id
  accepts_nested_attributes_for :spree_images, allow_destroy: true
